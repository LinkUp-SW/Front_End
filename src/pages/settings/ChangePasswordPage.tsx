              ...
              <div className="absolute top-full left-0 w-[300px] bg-white rounded-lg shadow-[0_0_10px_rgba(0,0,0,0.2)] mt-2 z-[100] border border-[#e0e0e0]">
                ...
                <ul className="list-none p-4 m-0">
                  {[
                    ...
                    <li
                      key={index}
                      className="relative py-2 text-sm text-[rgba(0,0,0,0.9)] border-b border-[#f3f3f3] last:border-b-0"
                    >
                      {rule}
                    </li>
                  ))}
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col relative mb-2">
            <label
              ...
              className="text-sm text-[rgba(0,0,0,0.8)] mb-2"
            >
              Type your current password{" "}
              <span className="text-[#d11124]">*</span>
            </label>
