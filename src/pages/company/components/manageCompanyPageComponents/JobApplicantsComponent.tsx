...
const JobApplicantsComponent: React.FC<JobApplicantsComponentProps> = ({
  jobId,
  onBack,
}) => {
  ...
  const handleStatusChange = async (
    applicantId: string,
    newStatus: JobApplicant["application_status"]
  ) => {
    try {
            ...
            >
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <div className="w-16 h-16 rounded-full overflow-hidden bg-gray-200 dark:bg-gray-600 flex-shrink-0">
                  <img
                    src={
                      applicant.user_id?.profile_photo ||
                ...
                <div className="flex flex-col gap-2">
                  <span
                    className={`px-3 py-1 text-xs rounded-full self-end ${getStatusColor(
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleStatusChange(
                        applicant._id,
                        e.target.value as JobApplicant["application_status"]
                      )
                    }
                  >
