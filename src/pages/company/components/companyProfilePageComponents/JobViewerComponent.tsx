...
const JobViewerComponent: React.FC<JobViewerProps> = ({ companyId, isVisible }) => {
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-700 p-6 my-6">
      ...
      {jobs.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-8">
          ...
          <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-2 text-center">No open positions</h3>
