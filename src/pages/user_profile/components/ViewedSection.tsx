...
const ViewedSection = () => {
  return (
    ...
    <h2 className="text-xl font-bold mb-4 text-black dark:text-white">Viewers also viewed</h2>
    <div className="space-y-4">
      ...
      {[1, 2, 3].map((item) => (
        <div key={item} className="flex items-center gap-3">
          ...
          <div>
            <p className="font-medium text-gray-900 dark:text-gray-200">John Doe</p>
