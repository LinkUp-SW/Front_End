  ...
  return (
    <>
      <div className="border-1 border-[#e8e8e8]">
        ...
        <button className={BUTTON_STYLE}>Unread</button>
        <button className={BUTTON_STYLE}>My Connections</button>
        <button className={BUTTON_STYLE}>InMail</button>
        <button className={BUTTON_STYLE}>Starred</button>
      </div>
    </>
  );
};
