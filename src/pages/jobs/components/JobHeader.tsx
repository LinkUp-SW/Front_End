// src/pages/SeeMorePage/components/JobListings/JobHeader.tsx
  ...
  return (
    <>
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        ...
        <button className="border border-gray-300 text-gray-700 py-2 px-4 md:px-6 rounded-full text-sm font-medium">
          Save
        </button>
      </div>
    </>
