  ...
  return (
    ...
    >
      <CardHeader className="pb-4">
        <CardTitle className="text-2xl font-semibold">Premium Plan</CardTitle>
      ...
      <CardContent className="flex-grow">
        <ul className="space-y-4">
          ...
          <FeatureItem available>Priority customer support</FeatureItem>
        </ul>
      </CardContent>
...
function FeatureItem({ icon, available, children }: FeatureItemProps) {
  return (
    <li className="flex items-start">
      ...
      <span className={available ? "" : "text-gray-500 dark:text-gray-600"}>
        {children}
      </span>
    </li>
  );
